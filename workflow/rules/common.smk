...
def get_pull_resources_output(wildcards):
    ...
    if organism == "human":
        final_files.extend([
            ...
            "resources/germline_variants/gnomAD/af_only_gnomad_hg38.vcf.gz",
            "resources/germline_variants/gnomAD/af_only_gnomad_hg38.vcf.gz.tbi",
            "resources/germline_variants/gnomAD/common_biallelic_chr1.vcf.gz",
            "resources/germline_variants/gnomAD/common_biallelic_chr1.vcf.gz.tbi",
