...
nextflow run nf-core/sarek -r 3.8.1 \
	...
	--wes \
	--intervals </path/to/output/nextflow.config >-profile <samplesheet.csv >--outdir </path/to/output/directory >--tools </path/to/oblx/library >/resources/exome_definition/ref_exome.bed
```
