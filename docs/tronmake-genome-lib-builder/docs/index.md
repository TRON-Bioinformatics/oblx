...
The workflow consists of the two stages below. Both stages can be executed 
independent from each other (described in the linked documentation pages).

1. [Pull resources](pull_resources.md)
2. [Build indices](build_indices.md)
