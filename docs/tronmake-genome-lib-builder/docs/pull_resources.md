...
The list of viruses (`workflow/resources/tcga_viruses.tsv`) was downloaded from [TCGA](https://gdc.cancer.gov/system/files/public/file/GRCh83.d1.vd1_virus_decoy.txt).
